...
//window.location.replace("../index.phtml");
        ...
        location.href="http://localhost:8080/index.php?pack1="+pack1;
        pack1=new Array();
    }
    else{
...
function guardarCanal2(){
    if(confirm(canal(pack2)=="vacia.\n"?"Su lista es:\n"+canal(pack2):"Esta operacion sobrescribira su configuracion actual.\nEstas seguro?")){
        location.href="http://localhost:8080/index.php?pack2="+pack2;
        pack2=new Array();
    }
    else{
        if(canal(pack2)!="vacia.\n"){
            if(confirm("Su lista es:\n"+canal(pack2)+"\nPuede: \n-Cancelar y seguir agregando\n-Aceptar para empezar desde 0?")){
                pack2=new Array();
            }
        }    
...
function guardarCanal3(){
    if(confirm(canal(pack3)=="vacia.\n"?"Su lista es:\n"+canal(pack3):"Esta operacion sobrescribira su configuracion actual.\nEstas seguro?")){
        location.href="http://localhost:8080/index.php?pack3="+pack3;
        pack3=new Array();
    }
    else{
        if(canal(pack3)!="vacia.\n"){
            if(confirm("Su lista es:\n"+canal(pack3)+"\nPuede: \n-Cancelar y seguir agregando\n-Aceptar para empezar desde 0?")){
                pack3=new Array();
            }
        }    
...
function guardarCanal4(){
    if(confirm(canal(pack4)=="vacia.\n"?"Su lista es:\n"+canal(pack4):"Esta operacion sobrescribira su configuracion actual.\nEstas seguro?")){
        location.href="http://localhost:8080/index.php?pack4="+pack4;
        pack4=new Array();
    }
    else{
        if(canal(pack4)!="vacia.\n"){
            if(confirm("Su lista es:\n"+canal(pack4)+"\nPuede: \n-Cancelar y seguir agregando\n-Aceptar para empezar desde 0?")){
                pack4=new Array();
            }
        }    
...
function guardarCanal5(){
    if(confirm(canal(pack5)=="vacia.\n"?"Su lista es:\n"+canal(pack5):"Esta operacion sobrescribira su configuracion actual.\nEstas seguro?")){
        location.href="http://localhost:8080/index.php?pack5="+pack5;
        pack5=new Array();
    }
    else{
        if(canal(pack5)!="vacia.\n"){
            if(confirm("Su lista es:\n"+canal(pack5)+"\nPuede: \n-Cancelar y seguir agregando\n-Aceptar para empezar desde 0?")){
                pack5=new Array();
            }
        }    
...
function guardarCanal6(){
    if(confirm(canal(pack6)=="vacia.\n"?"Su lista es:\n"+canal(pack6):"Esta operacion sobrescribira su configuracion actual.\nEstas seguro?")){
        location.href="http://localhost:8080/index.php?pack6="+pack6;
        pack6=new Array();
    }
    else{
        if(canal(pack6)!="vacia.\n"){
            if(confirm("Su lista es:\n"+canal(pack6)+"\nPuede: \n-Cancelar y seguir agregando\n-Aceptar para empezar desde 0?")){
                pack6=new Array();
            }
        }    
